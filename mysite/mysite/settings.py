...
# =============================================================================
# НАСТРОЙКИ CSRF И СЕССИЙ (Для Django 4.0+ и предотвращения конфликтов на localhost)
# =============================================================================

# Разрешенные источники для CSRF запросов
if DEBUG:
    CSRF_TRUSTED_ORIGINS = [
        "http://127.0.0.1:6678",
        "http://localhost:6678",
        "https://127.0.0.1:6678",
        "https://localhost:6678",
    ]
else:
    CSRF_TRUSTED_ORIGINS = [
        "https://dpits-cms.ru",
