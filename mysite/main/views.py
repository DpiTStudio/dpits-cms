...
class MaintenanceMixin:
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        Действия:
        1. Загружает настройки сайта БЕЗ кэширования (для актуальности статуса)
        ...
        """
        # Загружаем настройки напрямую из БД без кэширования
        # чтобы статус site_closed всегда был актуальным
