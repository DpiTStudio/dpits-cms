...
# ФАЙЛ: MODELS.PY                                                                               #
# ОПИСАНИЕ:                                                                                     #
# Определяет структуру данных (модели) для приложения Портфолио. Содержит сущности для          #
# хранения работ, категорий, клиентов, заказов и отзывов. Отвечает за логику работы с данными,  #
# генерацию уникальных ссылок (slug) и интеграцию с другими частями системы.                    #
#                                                                                               #
# НЮАНСЫ И ФУНКЦИОНАЛ:                                                                          #
# 1. Основные модели:                                                                           #
#    - PortfolioCategory: Категории проектов с поддержкой Hero-секций (баннеров) и SEO-полей.   #
#    - PortfolioItem: Сама работа портфолио с галереей, описанием, стеком технологий и статусами#
#    - Client: Расширенный профиль пользователя-заказчика (компания, контакты).                 #
#    - Order: Система управления заказами (статусы, сроки, бюджет, переписка).                  #
#    - PortfolioReview: Модель отзывов с рейтингом и модерацией.                                #
# 2. Особенности реализации:                                                                    #
#    - Автоматическая генерация slug (URL) при сохранении с проверкой уникальности.             #
#    - Интеграция с CKEditor 5 для богатого форматирования текста (описание работ).             #
#    - Использует HeroMixin для управления баннерами категорий и работ.                         #
#    - Сигнало-подобная логика в методе save() для автоматического создания новостей при        #
#      публикации работы (create_news_from_portfolio).                                          #
#    - Мульти-статусная система для заказов (Новый, В работе, Завершен) и работ (Черновик/Публ).#
# ============================================================================================= #
# portfolio/models.py
import datetime
