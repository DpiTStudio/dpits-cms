...
urlpatterns = [
    ...
    # API для получения изображения категории (используется в admin JS)
    path(
    ...
    # AJAX живой поиск
    # URL: /news/api/live-search/?q=<query>
    path("api/live-search/", views.news_live_search, name="live_search"),

    # API статистики новостей
    # URL: /news/api/stats/
