...
SECRET_KEY = "django-insecure-ggb-34chy82xwd424vn41_=i=nr$2mrxm5_-xj(ev6ed#h+_="
...
ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
    "dpits-cms.ru",  # Ваш домен
    "www.dpits-cms.ru",
    # Добавьте IP сервера, если нужно
]
...
# Для разработки - отключаем все SSL настройки
# if DEBUG:
...
# else:
#     # Для продакшена оставляем настройки безопасности
...
# =============================================================================
# ИСПРАВЛЕНИЕ ПРОБЛЕМЫ С SSL/HTTPS
# =============================================================================
...
#     print(f"DEBUG={DEBUG}")
#     print("SECURE_SSL_REDIRECT=False (Принудительно отключено)")
#     print("ВАЖНО: Пожалуйста, используйте 'http://' вместо 'https://'")
#     print("Если браузер перенаправляет на https, попробуйте режим Инкогнито")
#     print("или очистите HSTS настройки для localhost.")
#     print("----------------------------------------------------------------\n")
